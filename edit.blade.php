            ...
            <div class="panel-body">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <!-- 20181114 Changed by SHC PL:20180816_CP_005 disabled email if is edit user-->
                        @if(isset($user->id))
                            {!! Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'user email', 'autocomplete' => 'off', 'disabled'=>'disabled']) !!}
                        @else
                    ...
                    <a href="{!! URL::route('u.delete',['id' => $user->id, '_token' => csrf_token()]) !!}" class="btn btn-danger pull-right margin-left-5 delete">Delete user</a>

                    @endif
                    @if(isset($user->id))
                        {!! Form::hidden('editMode', 1) !!}
                    @endif
